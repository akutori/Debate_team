            ...
            @foreach($room as $room_once)
                ...
                <dialog id="dialog2{{$room_once->r_id}}" class="dialog_style" >
                    ...
                    <div class="nnn2">
                        ...
                        <div class="under">
                        <input type="button" class="popb1" onclick="location.href='{{url('/schat',compact($room_once->r_id,1,0))}}'" value="発言者">
                        <input type="button" class="popb1" onclick="location.href='{{url('/schat',compact($room_once->r_id,1,1))}}'" value="傍観者">
                        </div>
