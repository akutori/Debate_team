    ...
    <div id="wrapper">
        ...
        <div class="row row-cols-1 row-cols-lg-2 justify-content-center">
            <div class="card m-2" style="width: 15rem;">
                ...
                <button type="button" class="btn rounded-pill btn-primary mb-2"
                        onclick="location.href='{{url('/sgenre')}}'">ジャンル選択
                </button>
            </div>
            <div class="card m-2" style="width: 15rem;">
                <a href="{{ url('/makeroom') }}">
                ...
                <button type="button" class="btn rounded-pill btn-primary mb-2"
                        onclick="location.href='{{url('/makeroom')}}'">ルーム作成
                </button>
            </div>
            <div class="card m-2" style="width: 15rem;">
                <a href="{{ url('/ranking') }}">
                ...
                <button type="button" class="btn rounded-pill btn-primary mb-2"
                        onclick="location.href='{{url('/ranking')}}'">ランキングに行く
                </button>
            </div>
        </div>
        <br class="h-25">
        <div class="row row-cols-1 row-cols-lg-2 justify-content-center">
            <div class="card m-2" style="width: 15rem;">
                ...
                <button type="button" class="btn rounded-pill btn-primary mb-2"
                        onclick="location.href='{{url('/delroom')}}'">ルーム削除
                </button>
            </div>
            <div class="card m-2" style="width: 15rem;">
                <a href="{{ url('/') }}">
                ...
                <button type="button" class="btn rounded-pill btn-primary mb-2" onclick="location.href='{{url('/')}}'">
                    説明を見る
                </button>
            </div>
            <div class="card m-2" style="width: 15rem;">
