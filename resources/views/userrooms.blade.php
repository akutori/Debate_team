    ...
    @foreach ($errors->all() as $error)
        <div class="alert alert-danger text-center" role="alert">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                 class="bi bi-exclamation-triangle flex-shrink-0 ms-4 position-absolute top-50 start-0 translate-middle"
                 viewBox="0 0 16 15">
                <path
            ...
            <button type="button" class="btn-close float-end border-0" data-bs-dismiss="alert"
            ...
            <div class="row mb-5" style="background-color: rgb(14,92,102)">
                <div class="col-2 text-dark">
                    @if(\Illuminate\Support\Facades\Auth::id()==$room->id)
                        ...
                        <!-- モーダルの設定 -->
                        <div class="modal fade text-dark" id="selectroom{{$room->r_id}}" data-bs-backdrop="static"
                                    ...
                                    <form action="{{url('/standby')}}" method="get">{{--todo パラメータを合わせるまでは保留--}}
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-check ms-5">
                                                <input type="radio" value="0" class="form-check-input fs-4"
                                                       name="position"
                                                       id="debater" required>
                                            ...
                                            <div class="form-check ms-5">
                                                <input type="radio" value="1" class="form-check-input fs-4"
                                                       name="position"
